...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(sConfig->GetStringDefault("Motd", "Welcome to a DarkmoonCore server."));
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outString();
    sLog->outString("Loading DarkmoonCore strings...");
    if (!sObjectMgr->LoadDarkmoonCoreStrings())
...
namespace Trinity
{
    class WorldWorldTextBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetDarkmoonCoreString(i_textId, loc_idx);
