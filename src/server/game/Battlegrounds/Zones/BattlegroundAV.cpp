...
void BattlegroundAV::HandleKillUnit(Creature *unit, Player *killer)
{
    ...
    */
    ...
    else if (entry == BG_AV_CreatureInfo[AV_NPC_A_CAPTAIN][0])
    {
        ...
        if (creature)
            YellToAll(creature, GetDarkmoonCoreString(LANG_BG_AV_A_CAPTAIN_DEAD), LANG_UNIVERSAL);
    ...
    else if (entry == BG_AV_CreatureInfo[AV_NPC_H_CAPTAIN][0])
    {
        ...
        Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
        if (creature)
            YellToAll(creature, GetDarkmoonCoreString(LANG_BG_AV_H_CAPTAIN_DEAD), LANG_UNIVERSAL);
...
void BattlegroundAV::EventPlayerDestroyedPoint(BG_AV_Nodes node)
{
    ...
    char buf[256];
    if (IsTower(node))
        sprintf(buf, GetDarkmoonCoreString(LANG_BG_AV_TOWER_TAKEN) , GetNodeName(node), (owner == ALLIANCE) ? GetDarkmoonCoreString(LANG_BG_AV_ALLY) : GetDarkmoonCoreString(LANG_BG_AV_HORDE));
    else
        sprintf(buf, GetDarkmoonCoreString(LANG_BG_AV_GRAVE_TAKEN) , GetNodeName(node), (owner == ALLIANCE) ? GetDarkmoonCoreString(LANG_BG_AV_ALLY) :GetDarkmoonCoreString(LANG_BG_AV_HORDE));
...
//    }
    if (team == ALLIANCE || team == HORDE)
    {
        ...
        char buf[256];
        sprintf(buf, GetDarkmoonCoreString(LANG_BG_AV_MINE_TAKEN), GetDarkmoonCoreString((mine == AV_NORTH_MINE) ? LANG_BG_AV_MINE_NORTH : LANG_BG_AV_MINE_SOUTH), (team == ALLIANCE) ?  GetDarkmoonCoreString(LANG_BG_AV_ALLY) : GetDarkmoonCoreString(LANG_BG_AV_HORDE));
        Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
        if (creature)
            YellToAll(creature, buf, LANG_UNIVERSAL);
    }
...
void BattlegroundAV::EventPlayerDefendsPoint(Player* player, uint32 object)
{
   ...
   //spawn new go :)
    ...
    //send a nice message to all :)
    char buf[256];
    sprintf(buf, GetDarkmoonCoreString((IsTower(node)) ? LANG_BG_AV_TOWER_DEFENDED : LANG_BG_AV_GRAVE_DEFENDED), GetNodeName(node), (team == ALLIANCE) ?  GetDarkmoonCoreString(LANG_BG_AV_ALLY) : GetDarkmoonCoreString(LANG_BG_AV_HORDE));
    Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
    if (creature)
        YellToAll(creature, buf, LANG_UNIVERSAL);
...
void BattlegroundAV::EventPlayerAssaultsPoint(Player* player, uint32 object)
{
    ...
    //send a nice message to all :)
    char buf[256];
    sprintf(buf, (IsTower(node)) ? GetDarkmoonCoreString(LANG_BG_AV_TOWER_ASSAULTED) : GetDarkmoonCoreString(LANG_BG_AV_GRAVE_ASSAULTED), GetNodeName(node),  (team == ALLIANCE) ?  GetDarkmoonCoreString(LANG_BG_AV_ALLY) : GetDarkmoonCoreString(LANG_BG_AV_HORDE));
    Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
    if (creature)
        YellToAll(creature, buf, LANG_UNIVERSAL);
...
const char* BattlegroundAV::GetNodeName(BG_AV_Nodes node)
{
    switch (node)
    {
        case BG_AV_NODES_FIRSTAID_STATION:  return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_STORM_AID);
        case BG_AV_NODES_DUNBALDAR_SOUTH:   return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_DUN_S);
        case BG_AV_NODES_DUNBALDAR_NORTH:   return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_DUN_N);
        case BG_AV_NODES_STORMPIKE_GRAVE:   return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_STORMPIKE);
        case BG_AV_NODES_ICEWING_BUNKER:    return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_ICEWING);
        case BG_AV_NODES_STONEHEART_GRAVE:  return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_STONE);
        case BG_AV_NODES_STONEHEART_BUNKER: return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_STONE);
        case BG_AV_NODES_SNOWFALL_GRAVE:    return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_SNOW);
        case BG_AV_NODES_ICEBLOOD_TOWER:    return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_ICE);
        case BG_AV_NODES_ICEBLOOD_GRAVE:    return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_ICE);
        case BG_AV_NODES_TOWER_POINT:       return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_POINT);
        case BG_AV_NODES_FROSTWOLF_GRAVE:   return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_FROST);
        case BG_AV_NODES_FROSTWOLF_ETOWER:  return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_FROST_E);
        case BG_AV_NODES_FROSTWOLF_WTOWER:  return GetDarkmoonCoreString(LANG_BG_AV_NODE_TOWER_FROST_W);
        case BG_AV_NODES_FROSTWOLF_HUT:     return GetDarkmoonCoreString(LANG_BG_AV_NODE_GRAVE_FROST_HUT);
        default:
