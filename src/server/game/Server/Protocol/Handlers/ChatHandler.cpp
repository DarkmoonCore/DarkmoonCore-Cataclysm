...
void WorldSession::HandleMessagechatOpcode(WorldPacket & recv_data)
{
    ...
    if (type == CHAT_MSG_AFK)
    {
        ...
        if ((msg.empty() || !_player->isAFK()) && !_player->isInCombat())
        {
            ...
            {
                if (msg.empty())
                    msg  = GetDarkmoonCoreString(LANG_PLAYER_AFK_DEFAULT);
                _player->afkMsg = msg;
            }
    ...
    else if (type == CHAT_MSG_DND)
    {
        ...
        if (msg.empty() || !_player->isDND())
        {
            ...
            {
                if (msg.empty())
                    msg  = GetDarkmoonCoreString(LANG_PLAYER_DND_DEFAULT);
                _player->dndMsg = msg;
            }
    ...
    else
    {
        ...
        if (!_player->CanSpeak())
        {
            ...
            SendNotification(GetDarkmoonCoreString(LANG_WAIT_BEFORE_SPEAKING), timeStr.c_str());
            return;
        }
    ...
    if (GetPlayer()->HasAura(1852) && type != CHAT_MSG_WHISPER)
    {
        ...
        SendNotification(GetDarkmoonCoreString(LANG_GM_SILENCE), GetPlayer()->GetName());
        return;
    }
    ...
    switch (type)
    {
        ...
        case CHAT_MSG_YELL:
        {
            ...
            {
                SendNotification(GetDarkmoonCoreString(LANG_SAY_REQ), sWorld->getIntConfig(CONFIG_CHAT_SAY_LEVEL_REQ));
                return;
            }
        ...
        case CHAT_MSG_WHISPER:
        {
            ...
            {
                SendNotification(GetDarkmoonCoreString(LANG_WHISPER_REQ), sWorld->getIntConfig(CONFIG_CHAT_WHISPER_LEVEL_REQ));
                return;
            }
        ...
        case CHAT_MSG_CHANNEL:
        {
            ...
            {
                SendNotification(GetDarkmoonCoreString(LANG_CHANNEL_REQ), sWorld->getIntConfig(CONFIG_CHAT_CHANNEL_LEVEL_REQ));
                return;
            }
