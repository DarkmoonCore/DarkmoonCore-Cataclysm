...
#define MIN_DARKMOONCORE_STRING_ID           1                    // 'darkmooncore_string'
#define MAX_DARKMOONCORE_STRING_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_DARKMOONCORE_STRING_ID // 'db_script_string'
...
struct DarkmoonCoreStringLocale
{
...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        bool LoadDarkmoonCoreStrings(char const* table, int32 min_value, int32 max_value);
        bool LoadDarkmoonCoreStrings() { return LoadDarkmoonCoreStrings("darkmooncore_string", MIN_DARKMOONCORE_STRING_ID, MAX_DARKMOONCORE_STRING_ID); }
        ...
        DarkmoonCoreStringLocale const* GetDarkmoonCoreStringLocale(int32 entry) const
        {
        ...
        const char *GetDarkmoonCoreStringForDBCLocale(int32 entry) const { return GetDarkmoonCoreString(entry, DBCLocaleIndex); }
...
// scripting access functions
 bool LoadDarkmoonCoreStrings(char const* table, int32 start_value = MAX_CREATURE_AI_TEXT_STRING_ID, int32 end_value = std::numeric_limits<int32>::min());
 uint32 GetAreaTriggerScriptId(uint32 trigger_id);
 uint32 GetScriptId(const char *name);
