...
void SystemMgr::LoadScriptTexts()
{
    ...
    LoadDarkmoonCoreStrings("script_texts", TEXT_SOURCE_RANGE, 1+(TEXT_SOURCE_RANGE*2));
...
void SystemMgr::LoadScriptTextsCustom()
{
    ...
    LoadDarkmoonCoreStrings("custom_texts", TEXT_SOURCE_RANGE*2, 1+(TEXT_SOURCE_RANGE*3));
