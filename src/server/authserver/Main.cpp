...
char serviceLongName[] = "DarkmoonCore Auth service";
char serviceDescription[] = "DarkmoonCore World of Warcraft emulator world auth service";
/*
...
extern int main(int argc, char **argv)
{
    ...
    sLog->outString("::::::D::A::R::K::M::O::O::N::C::O::R::E::::::");
	sLog->outString(" :::::::::::::C A T A C L Y S M::::::::::::::");
    sLog->outString("     <http://www.darkmooncore.org/> ");
    ...
    {
        sLog->outError("DarkmoonCoreAuth can not bind to %s:%d", bind_ip.c_str(), rmport);
        return 1;
    }
...
#ifdef _WIN32
    {
        ...
        if (Prio)
        {
            if (SetPriorityClass(hProcess, HIGH_PRIORITY_CLASS))
                sLog->outString("DarkmoonCoreAuth process priority class set to HIGH");
            else
