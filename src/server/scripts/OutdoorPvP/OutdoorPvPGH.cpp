...
void OPvPCapturePointGH::ChangeState()
{
    ...
    case OBJECTIVESTATE_ALLIANCE:
        sWorld->SendZoneText(GH_OUTDOORPVP_ZONE, sObjectMgr->GetDarkmoonCoreStringForDBCLocale(LANG_OPVP_GH_LOOSE_A));
        DeSpawnNPCs();
        break;
    case OBJECTIVESTATE_HORDE:
        sWorld->SendZoneText(GH_OUTDOORPVP_ZONE, sObjectMgr->GetDarkmoonCoreStringForDBCLocale(LANG_OPVP_GH_LOOSE_H));
        DeSpawnNPCs();
        break;
    ...
    case OBJECTIVESTATE_ALLIANCE:
        ...
        artkit = 2;
        sWorld->SendZoneText(GH_OUTDOORPVP_ZONE, sObjectMgr->GetDarkmoonCoreStringForDBCLocale(LANG_OPVP_GH_CAPTURE_A));
        break;
    case OBJECTIVESTATE_HORDE:
        m_VentureState = VENTURE_H;
        FactionTakeOver(HORDE);
        artkit = 1;
        sWorld->SendZoneText(GH_OUTDOORPVP_ZONE, sObjectMgr->GetDarkmoonCoreStringForDBCLocale(LANG_OPVP_GH_CAPTURE_H));
        break;
    case OBJECTIVESTATE_NEUTRAL_ALLIANCE_CHALLENGE:
