...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "darkmooncore_string",          SEC_ADMINISTRATOR, true,  &HandleReloadDarkmoonCoreStringCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadDarkmoonCoreStringCommand(handler,"");
    ...
    static bool HandleReloadDarkmoonCoreStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading darkmooncore_string Table!");
        sObjectMgr->LoadDarkmoonCoreStrings();
        handler->SendGlobalGMSysMessage("DB table `darkmooncore_string` reloaded.");
        return true;
    }
